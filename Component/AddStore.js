...
const AddStore = (props) => {
   ...
   const  gotoaddresturant =()=>{
    props.history.push('/addresturant')
    }
    return (
        <div>
            <Container>
        ...
        <Col xs="12" style={{marginTop:'20px',display:'flex'}}>
            ...
            <Col xs='3' style={{marginBottom:'20px'}}>
                <Button  onClick={()=> gotoGoal() } onClick={()=>gotoaddresturant()} style={{marginLeft:'-16px',width:'100%',height:'50px',backgroundColor:'white',color:'black'}}>Healthy food resturant</Button> 
            </Col>
            <Col xs='3' style={{marginBottom:'20px'}}>
                <Button  color="warning"onClick={()=> gotoaddstore() } style={{marginLeft:'-16px',width:'100%',height:'50px'}}>supplement store</Button> 
            </Col>
          </Col>
